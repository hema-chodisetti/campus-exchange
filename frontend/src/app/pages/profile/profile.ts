...
import { UserProfile, Listing } from '../../models';
...
@Component({
  ...
  styles: [`
    ...
    .listing-title:hover { color: #e94560; }
    .listing-price { font-weight: 600; color: #e94560; }
    .listing-status {
      padding: 4px 10px;
      border-radius: 4px;
      font-size: 0.8rem;
    ...
    .btn-edit:hover { background: #1a1a2e; color: white; }
    .btn-delete {
      padding: 4px 12px;
